...
export const StoreScreen: React.FC<Props> = ({products}) => {
      ...
      <Stack spacing={6}>
        {Boolean(products.length) ? (
            ...
            {products.map(product => 
              <Stack data-test-id="product" key={product.id} spacing={3} backgroundColor="gray.100" borderRadius="md" padding={4} >
                <Image 
                  as={motion.img}
                  cursor="pointer"
                  layoutId={product.id}
            ...
            <Text color ="gray.400" margin="auto">
